...
app.add_page("ML: Predict Edible", page_predict_edible_body)
app.add_page("ML: Cluster Mushroom", page_cluster_mushroom_body)
app.add_page("ML: Classify Mushroom", page_classify_mushroom_body)
